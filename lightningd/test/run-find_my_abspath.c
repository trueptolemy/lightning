...
/*  Generated stub for new_inter_command_connection */
struct inter_command_connection *new_inter_command_connection(const tal_t *ctx UNNEEDED)
{ fprintf(stderr, "new_inter_command_connection called!\n"); abort(); }
