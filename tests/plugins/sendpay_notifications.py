#!/usr/bin/env python3
"""This plugin is used to check that sendpay_success and sendpay_fail calls are working correctly.
"""
...
@plugin.subscribe("sendpay_fail")
def notify_sendpay_fail(plugin, sendpay_fail):
    plugin.log("receive a sendpay_fail recored, id: {}, payment_hash: {}".format(sendpay_fail['data']['id'], sendpay_fail['data']['payment_hash']))
    plugin.fail_list.append(sendpay_fail)
