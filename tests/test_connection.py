...
def test_deprecated_fundchannel(node_factory, bitcoind):
    ...
    nodes = node_factory.get_nodes(2)
    ...
    with pytest.raises(RpcError, match=r'Need set \'amount\' field'):
        l1.rpc.call('fundchannel', {'id': nodes[1].info['id'], 'feerate': '2000perkw'})

    # Old style(object type)
    l1.rpc.call('fundchannel', {'id': nodes[1].info['id'], 'satoshi': 'all', 'feerate': 'slow', 'minconf': 1})
