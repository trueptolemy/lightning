...
/* Generated stub for notification_call */
void notification_call(struct lightningd *ld UNNEEDED, const char* topic UNNEEDED,
		       void *payload UNNEEDED)
{ fprintf(stderr, "notification_call called!\n"); abort(); }
